...
create table COMMANDE (
   ...
   IDADRESSEFACTURATION		int                  not null,
   IDCLIENT					int                  not null,
   IDSTATUT					int                  not null,
   DATECOMMANDE				datetime             not null,
   IPCOMMANDE				varchar(20)          not null,
   NUMEROTRANSACTION		varchar(20)          not null,
...
create table DETAILCOMMANDE (
   ...
   QUANTITEDETAILCOMMANDE	int                  not null,
   PRIXHTDETAILCOMMANDE		decimal              not null,
   TAUXTVADETAILCOMMANDE	decimal              not null,
...
create table ENTREPRISE (
   ...
   SIRETENTREPRISE      varchar(50)          not null,
...
create table ADRESSE (
   ...
   NUMADRESSE           varchar(10)          not null,
   VOIEADRESSE			varchar(50)			 not null,
   CODEPOSTAL           varchar(10)          not null,
   VILLE                varchar(50)          not null,
   CPTADRESSE           varchar(200)         not null,
...
create table ENREGISTREMENTFACTURE (
   IDCLIENT             int                  not null,
   IDADRESSE            int                  not null,
   DATEENREGISTREMENTFACTURE datetime        not null,
...
create table ENREGISTREMENTLIVRAISON (
   IDCLIENT             int                  not null,
   IDADRESSE            int                  not null,
   DATEENREGISTREMENTLIVRAISON datetime      not null,
...
CODEISBN             char(13)             not null,   
QUANTITEDETAILPANIER int                  not null,   
...
PROMOTIONEVENEMENT   int                  not null,   
LOGOEVENEMENT        varchar(250)         not null,   
DATEDEBUTEVENEMENT   datetime             not null,   
DATEFINEVENEMENT     datetime             not null,   
...
create table PRIX (   
IDPRIX               int              identity,   
MONTANTHT            decimal              not null,   
DATEMAJPRIX          datetime             not null,   
...
COUVLIVRE            varchar(250)         not null,   
RESUMELIVRE          text                 not null,   
STOCKLIVRE           int                  not null,   
DATESORTIE           date				  not null,   
POIDSLIVRE           decimal              not null,   
